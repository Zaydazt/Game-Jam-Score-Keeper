...
export default function Home() {
  ...
  return (
    ...
    >
      {/* Overlay for tinting the background */}
      <div className="absolute inset-0 bg-background/80 pointer-events-none" />

      {/* Main Content */}
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col h-full max-h-[90vh]">
        ...
        {gameState !== "setup" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full flex-1">
            ...
            {/* Middle / History Area */}
            <div className="lg:col-span-4 flex flex-col gap-4 h-[300px] lg:h-auto">
